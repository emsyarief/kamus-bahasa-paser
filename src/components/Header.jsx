    ...
    <header className="sticky top-0 z-50 border-b border-ink/15 bg-nav-bg/90 backdrop-blur-md">
      <nav className="mx-auto flex max-w-wrap items-center justify-between gap-4 px-pad-x py-4">
        <div className="flex flex-1 gap-7">
          <a className="text-label text-ink/70 transition-colors hover:text-ink" href="#entri">02 / ENTRI</a>
          <a className="text-label text-ink/70 transition-colors hover:text-ink" href="#statistik">04 / STATISTIK</a>
        </div>
        ...
        <div className="flex flex-1 justify-end gap-7">
          <a className="text-label text-ink/70 transition-colors hover:text-ink" href="#kontribusi">05 / KONTRIBUSI</a>
